...
export default function AboutGamer() {
    ...
    <div className="contrato flex">
        ...
        <br/><br></br>
        <h6>Por favor, leia cuidadosamente este Contrato antes de utilizar o software
            ...
            <br/><br></br>
            <h6>Este Contrato de Licença de Usuário Final é um acordo fictício entre o usuário
            ...
            <hr></hr>
            <h6>A utilização de todo e qualquer serviço prestado pela R2HF, está condicionada ao aceite deste termo
                na sua totalidade.</h6>
        <br/><br/><br></br>
